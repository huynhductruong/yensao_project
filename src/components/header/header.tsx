...
export default function Header() {
    ...
    return (
        <div className="w-full bg-primary_bg p-2 md:p-3 flex flex-col items-center text-xs md:text-sm">
            <div className="w-[95%] md:w-5/6 flex justify-end md:justify-between">
            ...
            <hr className="w-full mt-2 md:mt-4" />
            <div className="w-[95%] md:w-5/6 flex justify-between mt-2 md:mt-3 items-center">
                ...
                <div className="text-white flex font-medium md:text-sm items-center uppercase space-x-3 md:space-x-10">
                    <div className="hidden md:flex space-x-10">
                        ...
                        <Link href="/cart?page=1" className="hover:text-red-500 duration-300 ease-in-out">
                            <h3>GIỎ HÀNG</h3>
                        </Link>
                        <Link href="#" className="hover:text-red-500 duration-300 ease-in-out">
                            <h3>TIN TỨC</h3>
